...
/* harmony import */ var _modules_about_about_video__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/about/about-video */ "./js/modules/about/about-video.js");
/* harmony import */ var _modules_plan_plan_tabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/plan/plan-tabs */ "./js/modules/plan/plan-tabs.js");
/* harmony import */ var _modules_coaches_coaches_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/coaches/coaches-slider */ "./js/modules/coaches/coaches-slider.js");
/* harmony import */ var _modules_reviews_reviews_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/reviews/reviews-slider */ "./js/modules/reviews/reviews-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_about_about_video__WEBPACK_IMPORTED_MODULE_2__["loadVideo"])();
    Object(_modules_plan_plan_tabs__WEBPACK_IMPORTED_MODULE_3__["tabInit"])();
    Object(_modules_coaches_coaches_slider__WEBPACK_IMPORTED_MODULE_4__["initSlider"])();
    Object(_modules_reviews_reviews_slider__WEBPACK_IMPORTED_MODULE_5__["initReviews"])();
    Object(_modules_feedback_form_validation__WEBPACK_IMPORTED_MODULE_6__["initFormValidate"])();
...
/***/ "./js/modules/about/about-video.js":
/*!*****************************************!*\
  !*** ./js/modules/about/about-video.js ***!
  \*****************************************/
...
var videoPlayer = document.querySelector('[data-player]');

var loadVideo = function loadVideo() {
  videoPlayer.addEventListener('click', function (evt) {
    evt.preventDefault();
...
/***/ "./js/modules/coaches/coaches-slider.js":
/*!**********************************************!*\
  !*** ./js/modules/coaches/coaches-slider.js ***!
  \**********************************************/
...
var initSlider = function initSlider() {
  ...
  var sliderCoaches = new Swiper('.coaches__slider', {
    // Навигация
    navigation: {
...
/*!************************************************!*\
  !*** ./js/modules/feedback/form-validation.js ***!
  \************************************************/
/*! exports provided: initFormValidate, formFeedback, formNameInput, formTelInput */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var formFeedback = document.querySelector('[data-feedback-form]'); // Форма

var formNameInput = formFeedback.querySelector('[data-feedback-name]'); // Инпут имени

var formTelInput = formFeedback.querySelector('[data-feedback-tel]'); // Инпут телефона
...
var planBlock = document.querySelector('[data-section-plan]'); // Секция абонементов

var tabList = planBlock.querySelector('[data-tab-list]'); // Список табов

var tabItemFirst = planBlock.querySelector('[data-tab-item-first]'); // Элемент первого таба

var tabItemSecond = planBlock.querySelector('[data-tab-item-second]'); // Элемент второго таба

var tabItemThird = planBlock.querySelector('[data-tab-item-third]'); // Элемент третьего таба

var tabFirst = tabItemFirst.querySelector('[data-tab-first]'); // Первый таб (1 месяц)

var tabSecond = tabItemSecond.querySelector('[data-tab-second]'); // Первый таб (6 месяцев)

var tabThird = tabItemThird.querySelector('[data-tab-third]'); // Первый таб (12 месяцев)

var planFirst = planBlock.querySelector('[data-plan-first]'); // Первый список (1 месяц)

var planSecond = planBlock.querySelector('[data-plan-second]'); // Первый список (6 месяцев)

var planThird = planBlock.querySelector('[data-plan-third]'); // Первый список (12 месяцев)

var tabInit = function tabInit() {
  // Прячем лишние списки абонементов при подгрузке js
  planSecond.style.display = 'none';
  planThird.style.display = 'none'; // Меняем значение data у скрытых списков

  planSecond.dataset.planSecond = 'is-hidden';
  planThird.dataset.planThird = 'is-hidden'; // Навешиваем обработчик клика на список табов
  ...
  tabList.addEventListener('click', function (evt) {
    if (evt.target.matches('a')) {
      ...
      if (evt.target === tabFirst) {
        ...
        planSecond.style.display = 'none';
        planThird.style.display = 'none'; // Перекидываем класс модификатора на выбранный элемент таба

        tabItemFirst.classList.add('tab-list__item--selected');
        tabItemSecond.classList.remove('tab-list__item--selected');
        tabItemThird.classList.remove('tab-list__item--selected'); // Перекидываем класс модификатора на выбранный таб

        tabFirst.classList.add('tab-list__link--selected');
        tabSecond.classList.remove('tab-list__link--selected');
        tabThird.classList.remove('tab-list__link--selected'); // Меняем значения data у списков

        planFirst.dataset.planFirst = 'is-shown';
        planSecond.dataset.planSecond = 'is-hidden';
        planThird.dataset.planThird = 'is-hidden'; // Меняем значение data у элементов таба

        tabItemFirst.dataset.tabItemFirst = 'is-selected';
        tabItemSecond.dataset.tabItemSecond = 'is-listed';
        tabItemThird.dataset.tabItemThird = 'is-listed'; // Меняем значение data у таба
        ...
        planFirst.style.display = 'none';
        planSecond.style.display = 'none';
        planThird.style.display = 'grid'; // Перекидываем класс модификатора на выбранный элемент таба

        tabItemFirst.classList.remove('tab-list__item--selected');
        tabItemSecond.classList.remove('tab-list__item--selected');
        tabItemThird.classList.add('tab-list__item--selected'); // Перекидываем класс модификатора на выбранный таб

        tabFirst.classList.remove('tab-list__link--selected');
        tabSecond.classList.remove('tab-list__link--selected');
        tabThird.classList.add('tab-list__link--selected'); // Меняем значения data у списков

        planFirst.dataset.planFirst = 'is-hidden';
        planSecond.dataset.planSecond = 'is-hidden';
        planThird.dataset.planThird = 'is-shown'; // Меняем значение data у элементов таба

        tabItemFirst.dataset.tabItemFirst = 'is-listed';
        tabItemSecond.dataset.tabItemSecond = 'is-listed';
        tabItemThird.dataset.tabItemThird = 'is-selected'; // Меняем значение data у таба
...
/***/ "./js/modules/reviews/reviews-slider.js":
/*!**********************************************!*\
  !*** ./js/modules/reviews/reviews-slider.js ***!
  \**********************************************/
